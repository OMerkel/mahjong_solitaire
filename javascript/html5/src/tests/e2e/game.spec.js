...
test.describe('Mahjong Solitaire app shell', () => {
  test('loads game view by default', async ({ page }) => {
    ...
    await expect(page.locator('#app-header-title')).toHaveText('Mahjong Solitaire');
...
test.describe('Options and settings', () => {
  test('can switch to heart layout and ink theme', async ({ page }) => {
    ...
    await expect(page.locator('#board svg text').first()).toContainText('tiles remaining');
  });
...
test.describe('Highscore reset confirmation', () => {
  test('today reset asks for confirmation and can be cancelled', async ({ page }) => {
    await page.goto('/');
    await page.locator('#btn-menu').click();
    await page.locator('#nav-options').click();
  ...
  test('week reset asks for confirmation and can be accepted', async ({ page }) => {
    await page.goto('/');
    await page.locator('#btn-menu').click();
    await page.locator('#nav-options').click();
  ...
  test('month reset asks for confirmation and can be accepted', async ({ page }) => {
    await page.goto('/');
    await page.locator('#btn-menu').click();
    await page.locator('#nav-options').click();
